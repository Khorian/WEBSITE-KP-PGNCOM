...
<head>
    ...
    <!-- Alpine.js CDN untuk Interaktivitas Filter -->
...
<body class="bg-gray-50 text-gray-800 font-sans">
    ...
    <section class="py-12 px-6 md:px-12 max-w-7xl mx-auto" x-data="{ selectedCategory: 'semua', searchQuery: '' }">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <!-- Berita 1 -->
            <div x-show="(selectedCategory === 'semua' || selectedCategory === 'infrastruktur') && ('PGAS Telkom Lampung Berhasil Tingkatkan Kapasitas Jaringan Fiber Optik'.toLowerCase().includes(searchQuery.toLowerCase()))" 
            ...
            <!-- Berita 2 -->
            <div x-show="(selectedCategory === 'semua' || selectedCategory === 'kegiatan') && ('Workshop Keamanan Siber untuk Mitra Bisnis Regional Lampung'.toLowerCase().includes(searchQuery.toLowerCase()))" 
                 class="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm flex flex-col justify-between transition-transform hover:-translate-y-1">
                <div>
            ...
            <!-- Berita 4 -->
            <div x-show="(selectedCategory === 'semua' || selectedCategory === 'sertifikasi') && ('Sertifikasi ISO 27001 untuk Keamanan Sistem Informasi'.toLowerCase().includes(searchQuery.toLowerCase()))" 
                 class="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm flex flex-col justify-between transition-transform hover:-translate-y-1">
                <div>
            ...
            <!-- Berita 5 -->
            <div x-show="(selectedCategory === 'semua' || selectedCategory === 'penghargaan') && ('Penghargaan Pelayanan Terbaik dari Asosiasi Telekomunikasi Indonesia'.toLowerCase().includes(searchQuery.toLowerCase()))" 
                 class="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm flex flex-col justify-between transition-transform hover:-translate-y-1">
                <div>
