...
<head>
    ...
    <title>Tambahkan Artikel Baru - PGANCOM</title>
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('images/favicon.ico') }}" type="image/png">
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"></script>
</head>
<body class="bg-slate-100 font-sans antialiased text-slate-800" x-data="formArtikel()">
...
<a href="/admin/pengguna" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800/40 font-medium text-sm transition">
    ...
    <span>Kelola pengguna</span>
        ...
        <main class="flex-1 p-8 overflow-y-auto pb-28">
            ...
            <nav class="flex text-xs font-medium text-slate-400 mb-2 space-x-2">
                ...
                <span>&rsaquo;</span>
                <a href="/admin/berita" class="hover:text-slate-600 transition">Berita</a>
                <span>&rsaquo;</span>
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-sm space-y-5">
                            ...
                            <div>
                                <label for="judul" class="block text-xs font-bold text-slate-700 mb-2">
                                    Judul artike <span class="text-red-500">*</span>
                                </label>
                                <input type="text" id="judul" name="judul" x-model="judul" @input="generateSlug()"
                                    value="PGASCOM Strengthens Digital Infrastructure in Nusantara Capital" required
                            ...
                            <div>
                                ...
                                <input type="text" id="slug" name="slug" x-model="slug" readonly
                                    value="pgascom-strengthens-digital-infrastructure-in-nusantara-capital"
                        ...
                        <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-sm">
                            ...
                            <div class="border border-slate-200 rounded-xl overflow-hidden">
                                ...
                                <textarea name="content" rows="10"
                                    class="w-full p-4 text-sm text-slate-800 leading-relaxed placeholder-slate-400 focus:outline-none resize-y">PT PGAS Telekomunikasi Nusantara (PGASCOM) is committed to driving high-speed reliable connectivity for key central nodes in Nusantara. Our engineering division has successfully laid out and tested sub-sea core architectures during early phases...</textarea>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-sm space-y-4">
                            ...
                            <div>
                                ...
                                <select id="category" name="category" class="w-full px-3.5 py-2.5 border border-slate-200 rounded-lg text-sm text-slate-700 bg-white focus:outline-none focus:border-sky-500">
                        ...
                        <!-- Sidebar Card 2: Featured Image -->
                        <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-sm">
                            <h3 class="font-bold text-sm text-slate-800 mb-3">Featured Image</h3>
                            ...
                            <div class="border-2 border-dashed border-slate-200 rounded-xl p-6 text-center hover:border-sky-400 transition cursor-pointer relative bg-slate-50/50">
                                <input type="file" name="featured_image" class="absolute inset-0 opacity-0 cursor-pointer">
                        ...
                        <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-sm space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="meta_title" value="Digital Infrastructure PGASCOM - IKN"
                            ...
                            <div>
                                ...
                                <textarea name="meta_description" rows="3"
                                    class="w-full px-3.5 py-2 border border-slate-200 rounded-lg text-xs text-slate-800 focus:outline-none focus:border-sky-500 resize-none">PT PGAS Telekomunikasi Nusantara reinforces the backbone operations at...</textarea>
                            </div>
                        </div>
                ...
                <div class="fixed bottom-0 right-0 left-64 bg-white border-t border-slate-200/80 p-4 px-8 flex items-center justify-between z-40">
                    <a href="/admin/berita" class="text-xs font-bold text-slate-500 hover:text-slate-800 transition">
                        Cancel
                    </a>
    ...
    <script>
        function formArtikel() {
            return {
                judul: 'PGASCOM Strengthens Digital Infrastructure in Nusantara Capital',
                slug: 'pgascom-strengthens-digital-infrastructure-in-nusantara-capital',
                generateSlug() {
